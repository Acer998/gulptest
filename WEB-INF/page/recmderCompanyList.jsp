...
<body class="fixed-sidebar fixed-nav">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">公司注册日期：</label>
                                <div class="col-sm-9">
                                    <input type="text" id="beginRegTime" class="form-control begin-date">-
                                    <input type="text" id="endRegTime" class="form-control end-date">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">状态：</label>
                                <div class="col-sm-9">
                                    <select type="text" id="refStatus" class="form-control">
    ...
    <script src="/resources/app/recmderCompanyList.js" type="text/javascript"></script>
